...
5. Si persisten riesgos, documentar si corresponden a decisiones locales controladas
   como `fly_admin` superuser o puerto expuesto al host.
...
## 11. Criterio de cierre de incidente
